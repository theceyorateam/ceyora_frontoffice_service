...
exports.create = async (data) => {
    const {vendorId, themeId, location, district, totalRatePoints, rateCount, vendorTitle, vendorDescription, vendorAdditionalData, registeredDate, vendorContactNo1, vendorContactNo2, vendorEmail, vendorRegion} = data;
