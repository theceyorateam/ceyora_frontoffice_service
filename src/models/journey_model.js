...
exports.create = async (data) => {
    ...
    try {
        ...
        const result = await db.query(
            `INSERT INTO ceyora_db.j1_joruney
             (vendor_id, scheduled_date_time, package_id, is_cancelled, cancelled_date, is_refunded, refunded_date,
              last_updated_date, is_vendor_approved, vendor_approved_date)
